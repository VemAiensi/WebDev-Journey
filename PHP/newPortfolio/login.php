...
<html>
    ...
    <body>
            ...
            <div class="row justify-content-center">
                <div class="col col-lg-5">
                    <form action="includes/controller.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="usernameInpute" class="form-label">Username</label>
                            <input type="text" class="form-control" name="usernameInput" id="usernameInput">
                        </div>
                        <div class="mb-3">
                            <label for="passwordInpute" class="form-label">Password</label>
                            <input type="text" class="form-control" name="passwordInput" id="passwordInput">
                        </div>
        ...
        <div class="footer footer-container fixed-bottom">
            <div class="links">

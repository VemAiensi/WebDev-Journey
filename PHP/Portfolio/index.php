    ...
    <body data-spy="scroll" data-target=".navbar">
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#reach">Contact Me</a></li>
            </ul>
        </nav>

        <section class="secDark sec1 text-center" id="home">
            <div>
                <h1 class="domain-title cl_white">VIBRANT ARROW</h1>
            </div>    
            <img src="Assets/LogoV2White.svg" height="50%">
        
            <div class="cl_white">
                <h1>My Virtual Space</h1>
                Explore the universe I live in.<br>
                <a href="#reach">
                    <button class="btn btn-default"><span class="glyphicon glyphicon-send"></span> Contact Me</button>
                </a>
                <br><br><br>
                Portfolio Project<br>
                Vem Aiensi Marasigan | 3BSCS-1
            </div>
            
        </section>

        <section id="exp" class="text-center frame-containers">
            <div>
                <h1>Experiences</h1>
                <br>
            </div>
                <div class="works">
                    <div class="work">
                        <iframe
                            src="https://vemaiensi.github.io/SemanticsProject/index.html"
                            name="targetframe"
                    ...
                    <div class="work">
                        ...
                        <iframe
                            src="https://vemaiensi.github.io/about.html"
                            name="targetframe"
                            allowTransparency="true"
                            scrolling="yes"
                            frameborder="0"
                ...
                <div class="works">
                    <div class="desc">
                        <span>Simple compiler in collaboration
                        with Marianne Edic as the TurtleDuck Team.
                        <a href="https://vemaiensi.github.io/SemanticsProject/index.html">See full page here.</a>
                        </span><br></div>
                    <div class="desc">
                        <span>My first static website using HTML and CSS
                        </span>
                    </div>
                </div>
        </section>
        ...
        <section class="secDark">
            <div>
                <h1 class="cl_white">Skills I Learn So Far...</h1>
                <br>
            </div>
            <div class="text-center">
                <?php //using php to automatically view icons
                    $icontexts = array("Blender","Bootstrap 3", 
                    "CSS", "SQL/Excel", "Git", "HTML5","Java", "Javascript", "PHP", "Python");


                    $folder = 'Assets/icons-myexp/';
                    $x=0;
                    $images = glob($folder.'*.svg', GLOB_BRACE);
        
                    foreach($images as $image){
                        echo "<a href='#' data-toggle='tooltip' data-placement='bottom'
                             title='$icontexts[$x]'>
                            <img src='$image' class='img-thumbnail icon' width='50px'>
                            </a>";
                        $x++;
                    }
                ?>
            ...
            <br><br>
            <h1 class="cl_white">Certificates</h1>
            <br><br>
                        ...
                        <ol class="carousel-indicators">
                            ...
                            <?php
                                ...
                                foreach($images as $image ){
                                    ...
                                    if ($len == 0)
                                        echo "<li data-target='#mycarousel' data-slide-to='$len' class='active'></li>";
                                    else
                                        echo "<li data-target='#mycarousel' data-slide-to='$len'></li>";
            ...
            <div class="certs">
                <?php //for certificates static view
                    $folder = 'Assets/certs/';
                    $x=0;
        ...
        <section id="about" class="secAbout">
            <h1>ABOUT</h1>
            <br>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 text-right">
                        <br>
                        <img src="Assets/IDpic.jpg" class="img-rounded">
                    </div>
                    <div class="col-md-6">
                        <p>Hello there!</p>
                ...
                <div class="row">
                    ...
                    <p>This image here is me trying to learn, one of the recent 
                        art I made and I want to transform it, or rather remake it 
                        to an svg format, as it is currently in gif form. The advantages
                         of svg is that its faster to processed by web and it is previewed as calculated vectors, instead of gifs which uses pixels, making the art look crisp in any zoom. But still it will take me a while to learn making svgs.</p>
                    </div>
                    <div class="col-md-5">
                    <img src="Assets/ImComputing-min.gif" class="img-rounded">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="reach" class="secDark contact">
            
            <h1 class="cl_white">CONTACT ME</h1>
            <br><br>
...
<style>
            ...
            @font-face {
                font-family: AT;
                src: url('Assets/Fonts/auto-techno.ttf');
            }
